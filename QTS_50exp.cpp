...
int main()
{
    ...
    cout << "m: " << m << endl;
    cout << "avg_fit: " << sum_fit / expTime << endl;
    cout << "avg_gate: " << sum_gate / expTime << endl;
    cout << "get_ans_cnt: " << get_ans_cnt << endl;
    cout << "avg_corret_gate: " << sum_corret_gate / get_ans_cnt << endl;
    cout << "all_best_fit: " << all_best << endl;
    cout << "allbest_gate" << allbest_gate_cnt << endl;
